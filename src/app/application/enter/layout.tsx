...
export default async function AdminLayout({
  ...
  if (!user) {
    redirect('/?auth=login&redirect=/application/enter')
  }
    ...
    <div className="relative min-h-screen overflow-x-clip bg-lp-surface font-sans text-lp-on-surface">
      ...
      <div className="relative z-10 flex h-screen overflow-hidden min-w-0">
        ...
        <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
          ...
          <main className="relative z-10 min-w-0 flex-1 overflow-y-auto overflow-x-clip px-4 pb-24 pt-4 sm:px-5 sm:pt-5 md:px-6 md:pt-6 lg:px-8 lg:pb-8 lg:pt-6">
            {children}
          </main>
        </div>
      </div>
